...
export type CouponsApplicableTo = 'all' | 'categories' | 'products'

export type CouponsDiscountType = 'fixed_amount' | 'percentage'
...
export type OrdersPaymentStatus = 'failed' | 'paid' | 'pending' | 'refunded'
...
export type PaymentMethodsProcessingFeeType = 'fixed' | 'percentage'
