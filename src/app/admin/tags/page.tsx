...
export default async function TagListPage(): Promise<JSX.Element> {
    ...
    return (
      <LayoutPageAdmin>
        <PageUI
          ...
          options={
            <PageButton href="/admin/tags/new">
              Nuevo Tag
            </PageButton>
          }
        >
          <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-12 text-center">
            ...
            <p className="mb-6 max-w-sm text-sm text-gray-500">
              Los tags te permiten etiquetar variantes de productos con badges como Nuevo, Bestseller, Eco-Friendly, etc.
            </p>
            <PageButton href="/admin/tags/new">
              + Crear primer tag
            </PageButton>
  ...
  return (
    <LayoutPageAdmin>
      <PageUI
        title={<PageTitle title="Tags" />}
        subtitle="Gestiona las etiquetas de productos"
        breadcrumb={[{ label: 'Tags', url: '/admin/tags' }]}
        options={
          <PageButton href="/admin/tags/new">
            Nuevo Tag
