#!/usr/bin/env npx tsx
/**
 * Customers E2E Test Runner
 *
 * Ejecuta todos los tests E2E del módulo Customers.
 *
 * Usage:
 *   npx tsx src/module/customers/e2e/index.ts
 */
...
async function main(): Promise<void> {
  console.log('\n' + '='.repeat(60))
  console.log('🧪 CUSTOMERS E2E TESTS')
  ...
  try {
    ...
    log('')
    await takeScreenshot('login-success', 'customers')

    // Run Admin tests
    console.log('\n' + '─'.repeat(60))
    console.log('👥 ADMIN CUSTOMERS TESTS')
    console.log('─'.repeat(60))
