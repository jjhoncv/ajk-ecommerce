#!/usr/bin/env npx tsx
/**
 * Attributes E2E Test Runner
 *
 * Ejecuta todos los tests E2E del módulo Attributes.
 *
 * Usage:
 *   npx tsx src/module/attributes/e2e/index.ts
 */
...
async function main(): Promise<void> {
  console.log('\n' + '='.repeat(60))
  console.log('🧪 ATTRIBUTES E2E TESTS')
  console.log('='.repeat(60))
  console.log('Testing attribute management functionality.\n')
  ...
  try {
    ...
    log('')
    await takeScreenshot('login-success', 'attributes')

    // Run Admin tests
    console.log('\n' + '─'.repeat(60))
    console.log('📦 ADMIN ATTRIBUTES TESTS')
    console.log('─'.repeat(60))
