#!/usr/bin/env npx tsx
/**
 * Shippings E2E Test Runner
 *
 * Ejecuta todos los tests E2E del módulo Shippings.
 *
 * Usage:
 *   npx tsx src/module/shippings/e2e/index.ts
 */
...
async function main(): Promise<void> {
  console.log('\n' + '='.repeat(60))
  console.log('🧪 SHIPPINGS E2E TESTS')
  console.log('='.repeat(60))
  console.log('Testing shipping management functionality.\n')
  ...
  try {
    ...
    log('')
    await takeScreenshot('login-success', 'shippings')

    // Run Admin tests
    console.log('\n' + '─'.repeat(60))
    console.log('🚚 ADMIN SHIPPINGS TESTS')
    console.log('─'.repeat(60))
