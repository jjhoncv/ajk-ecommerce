...
export class ProductVariantRepository {
  ...
  /**
   * Actualizar stock de una variante (con validacion de stock minimo)
   */
  ...
  /**
   * Actualizar multiples stocks en una transaccion
   */
   ...
   * Nota: Esto requeriria una columna adicional 'reserved_stock' en la tabla
   */
  public async reserveStock(
    ...
    // En una implementacion mas compleja, tendrias una columna reserved_stock
