#!/usr/bin/env npx tsx
/**
 * Offers E2E Test Runner
 *
 * Ejecuta todos los tests E2E del módulo Offers.
 *
 * Usage:
 *   npx tsx src/module/offers/e2e/index.ts
 */
...
async function main(): Promise<void> {
  console.log('\n' + '='.repeat(60))
  console.log('🏷️  OFFERS E2E TESTS')
  console.log('='.repeat(60))
  console.log('Testing offers management functionality.\n')
  ...
  try {
    ...
    log('')
    await takeScreenshot('login-success', 'offers')

    // Run Admin tests
    console.log('\n' + '─'.repeat(60))
    console.log('🏷️  ADMIN OFFERS TESTS')
    console.log('─'.repeat(60))
