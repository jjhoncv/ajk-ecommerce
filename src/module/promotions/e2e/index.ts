#!/usr/bin/env npx tsx
/**
 * Promotions E2E Test Runner
 *
 * Ejecuta todos los tests E2E del módulo Promotions.
 *
 * Usage:
 *   npx tsx src/module/promotions/e2e/index.ts
 */
...
async function main(): Promise<void> {
  console.log('\n' + '='.repeat(60))
  console.log('🧪 PROMOTIONS E2E TESTS')
  console.log('='.repeat(60))
  console.log('Testing promotions management functionality.\n')
  ...
  try {
    ...
    log('')
    await takeScreenshot('login-success', 'promotions')

    // Run Admin tests
    console.log('\n' + '─'.repeat(60))
    console.log('🏷️  ADMIN PROMOTIONS TESTS')
    console.log('─'.repeat(60))
