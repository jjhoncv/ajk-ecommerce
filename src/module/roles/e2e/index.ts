#!/usr/bin/env npx tsx
/**
 * Roles E2E Test Runner
 *
 * Ejecuta todos los tests E2E del módulo Roles.
 *
 * Usage:
 *   npx tsx src/module/roles/e2e/index.ts
 */
...
async function main(): Promise<void> {
  ...
  try {
    ...
    log('')
    await takeScreenshot('login-success', 'roles')

    // Run Admin CRUD tests
    console.log('\n' + '─'.repeat(60))
    console.log('🛡️ ADMIN CRUD TESTS')
    console.log('─'.repeat(60))
