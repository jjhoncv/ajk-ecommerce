#!/usr/bin/env npx tsx
/**
 * Payments E2E Test Runner
 *
 * Ejecuta todos los tests E2E del módulo Payments.
 *
 * Usage:
 *   npx tsx src/module/payments/e2e/index.ts
 */
...
async function main(): Promise<void> {
  console.log('\n' + '='.repeat(60))
  console.log('💳 PAYMENTS E2E TESTS')
  console.log('='.repeat(60))
  console.log('Testing payment methods management functionality.\n')
  ...
  try {
    ...
    log('')
    await takeScreenshot('login-success', 'payments')

    // Run Admin tests
    console.log('\n' + '─'.repeat(60))
    console.log('💳 ADMIN PAYMENTS TESTS')
    console.log('─'.repeat(60))
