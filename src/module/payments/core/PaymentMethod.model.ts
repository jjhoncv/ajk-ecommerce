...
export class PaymentMethodModel {
  ...
  // Method to calculate fees and validate a payment method
  ...
  // Method to validate if an amount is valid for a method
  ...
  // Method to get valid payment methods for an amount
  ...
  // Method to check if a method requires additional verification
  public requiresVerification(method: PaymentMethod): boolean {
    return method.requiresVerification === 1
  }

  // Method to get specific settings of a method
