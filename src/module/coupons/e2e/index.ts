#!/usr/bin/env npx tsx
/**
 * Coupons E2E Test Runner
 *
 * Ejecuta todos los tests E2E del módulo Coupons.
 *
 * Usage:
 *   npx tsx src/module/coupons/e2e/index.ts
 */
...
async function main(): Promise<void> {
  ...
  try {
    ...
    log('')
    await takeScreenshot('login-success', 'coupons')
