#!/usr/bin/env npx tsx
/**
 * Users E2E Test Runner
 *
 * Ejecuta todos los tests E2E del módulo Users.
 *
 * Usage:
 *   npx tsx src/module/users/e2e/index.ts
 */
...
async function main(): Promise<void> {
  ...
  try {
    ...
    log('')
    await takeScreenshot('login-success', 'users')
