#!/usr/bin/env npx tsx
/**
 * Ratings E2E Test Runner
 *
 * Ejecuta todos los tests E2E del módulo Ratings.
 *
 * Usage:
 *   npx tsx src/module/ratings/e2e/index.ts
 */
...
async function main(): Promise<void> {
  console.log('\n' + '='.repeat(60))
  console.log('⭐ RATINGS E2E TESTS')
  console.log('='.repeat(60))
  console.log('Testing ratings moderation functionality.\n')
  ...
  try {
    ...
    log('')
    await takeScreenshot('login-success', 'ratings')

    // Run Admin tests
    console.log('\n' + '─'.repeat(60))
    console.log('⭐ ADMIN RATINGS TESTS')
    console.log('─'.repeat(60))
