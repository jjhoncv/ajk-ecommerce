...
export function AuthModalProvider({ children }: AuthModalProviderProps) {
  ...
  const openLogin = (callbacks: AuthCallbacks = {}) => {
    console.log('🔐 Opening login modal with callbacks:', Object.keys(callbacks));
  ...
  const openRegister = (callbacks: AuthCallbacks = {}) => {
    console.log('📝 Opening register modal with callbacks:', Object.keys(callbacks));
    setCurrentCallbacks(callbacks);
